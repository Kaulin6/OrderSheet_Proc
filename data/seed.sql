...
INSERT INTO products (name, category, vendor, url, price) VALUES
  ...
  ('Fairview GR-9984 Automatic Changeover Propane Regulator', 'Nat Gas', 'Amazon', 'https://www.amazon.com/dp/B0CJL6M1S4', 47.99),
  ('SUNGATOR Brass Half-Union 3/8" MNPT x 3/8" Male Flare (2-Pack)', 'Nat Gas', 'Amazon', 'https://www.amazon.com/dp/B07XDYJZ9X', 6.99),
  ('GasSaf Stainless Braided Propane Hose Connector (Inverted Flare)', 'Nat Gas', 'Amazon', 'https://www.amazon.com/dp/B07YWN6KT7', 20.99);
