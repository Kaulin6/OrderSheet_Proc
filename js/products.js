...
const LOCAL_PRODUCTS = [
  ...
  { id: 2,  name: 'Non-Patrol Camera (E1 Outdoor Pro)', category: 'Security',          vendor: 'Reolink',          url: 'https://reolink.com/us/product/e1-outdoor-pro/', price: 130.00 },
  { id: 3,  name: 'Bullet Camera (Reolink Duo 3)',     category: 'Security',           vendor: 'Reolink',          url: 'https://reolink.com/product/reolink-duo-3-poe/', price: 161.00 },
  { id: 4,  name: 'Solar Wifi Camera (Atlas PT Ultra)', category: 'Security',          vendor: 'Reolink',          url: 'https://reolink.com/product/altas-pt-ultra/', price: 186.00 },
  { id: 5,  name: 'Solar LTE Camera (GO Ranger PT)',   category: 'Security',           vendor: 'Reolink',          url: 'https://reolink.com/ca/product/reolink-go-ranger-pt/?attribute_pa_version=camera-solar-panel-2', price: 184.00 },
  { id: 6,  name: 'Ledmo Wired (Wall Mount)',          category: 'Security',           vendor: 'Amazon',           url: 'https://www.amazon.com/dp/B086WSNVLJ/', price: 167.00 },
  { id: 7,  name: 'Ledmo Wired (Pole Mount)',          category: 'Security',           vendor: 'Amazon',           url: 'https://www.amazon.com/LEDMO-Adjustable-Photocell-Commercial-Lighting/dp/B089Y6JG2S/', price: 142.00 },
  { id: 8,  name: 'Ofuray Solar (Pole Mount)',         category: 'Security',           vendor: 'Amazon',           url: 'https://www.amazon.ca/Ofuray-238000LM-Commercial-Parking-Security/dp/B0DQ5GH9VT/', price: 195.00 },
  { id: 9,  name: 'Warm Light for Tucson 3000k',       category: 'Security',           vendor: 'Haloitte',         url: 'https://www.haloittelighting.com/products/led-area-light-120-277vac-300w-240w-200w-adjustable-5000k-4000k-3000k-0-10v-dim-type-iii-1pk', price: 119.00 },
  { id: 10, name: '12 Channels (RLN12W)',              category: 'MEP',                vendor: 'Reolink',          url: 'https://reolink.com/ca/product/rln12w/?attribute_pa_version=1-packwhite', price: 315.00 },
  { id: 11, name: '16 Channels (RLN16W)',              category: 'MEP',                vendor: 'Reolink',          url: 'https://reolink.com/ca/product/rln16-410/', price: 422.00 },
  { id: 12, name: 'Core Switch (TL-SG3428X)',          category: 'MEP',                vendor: 'Amazon',           url: 'https://www.amazon.com/gp/product/B08TR9FLDX/', price: 548.00 },
  { id: 13, name: 'Sub Switch (TL-SG2210MP)',          category: 'MEP',                vendor: 'Amazon',           url: 'https://www.amazon.com/gp/product/B0D5Z3NMG9/', price: 258.00 },
  { id: 14, name: 'Fiber Optics Cable',                category: 'MEP',                vendor: 'Amazon',           url: 'https://www.amazon.com/Outdoor-Armored-Multimode-Industrial-Installed/dp/B0DSJ1VS3V/', price: 150.00 },
  { id: 15, name: 'Fiber Transceiver',                 category: 'MEP',                vendor: 'Amazon',           url: 'https://www.amazon.com/gp/product/B01N1H1Z2F/', price: 58.00 },
  { id: 16, name: 'NVR 12" Monitor',                   category: 'MEP',                vendor: 'Amazon',           url: 'https://www.amazon.com/dp/B01KJVERF8/', price: 80.00 },
  { id: 17, name: 'Junction Box',                      category: 'MEP',                vendor: 'Amazon',           url: 'https://www.amazon.ca/Joinfworld-Electrical-Waterproof-Weatherproof/dp/B0DMZH73ZF/', price: 93.00 },
  { id: 18, name: 'Camera Pole Bracket',               category: 'Security',           vendor: 'Amazon',           url: 'https://www.amazon.com/Aimeboost-Vibration-Hardware-Accessories-Security/dp/B0BR3CD8RN/', price: null },
  { id: 19, name: 'Camera Wall Bracket',               category: 'Security',           vendor: 'Amazon',           url: 'https://www.amazon.com/dp/B0D78SS21X', price: null },
  { id: 20, name: 'Power Plugs for Lights',            category: 'Security',           vendor: 'Amazon',           url: 'https://www.amazon.com/HUARLPLUG-Certified-Rewirable-Directions-Adjustable/dp/B0DM8WBX7Y/', price: 16.00 },
  { id: 21, name: 'Mounting Tape for Signs',           category: 'Signage',            vendor: 'Amazon',           url: 'https://www.amazon.com/gp/product/B09G63579Q/', price: 20.00 },
  { id: 22, name: 'Smart Plug',                        category: 'MEP',                vendor: 'Amazon',           url: 'https://www.amazon.com/Kasa-Smart-Required-Certified-EP10P4/dp/B091FXLMS8/', price: 26.00 },
  { id: 23, name: 'OPS Signs',                         category: 'Signage',            vendor: 'SignQuick',        url: 'https://www.signquick.com/', price: null },
  { id: 24, name: 'Gate Signs',                        category: 'Signage',            vendor: 'SignQuick',        url: 'https://www.signquick.com/', price: null },
  { id: 25, name: 'Construction Signs',                category: 'Signage',            vendor: 'SignQuick',        url: 'https://www.signquick.com/', price: null },
  { id: 26, name: 'Starlink',                          category: 'Security',           vendor: 'Starlink',         url: 'https://starlink.com/business', price: null },
  ...
  { id: 40, name: 'Fairview GR-9984 Automatic Changeover Propane Regulator', category: 'Nat Gas', vendor: 'Amazon',    url: 'https://www.amazon.com/dp/B0CJL6M1S4', price: 47.99 },
  { id: 41, name: 'SUNGATOR Brass Half-Union 3/8" MNPT x 3/8" Male Flare (2-Pack)', category: 'Nat Gas', vendor: 'Amazon', url: 'https://www.amazon.com/dp/B07XDYJZ9X', price: 6.99 },
  { id: 42, name: 'GasSaf Stainless Braided Propane Hose Connector (Inverted Flare)', category: 'Nat Gas', vendor: 'Amazon', url: 'https://www.amazon.com/dp/B07YWN6KT7', price: 20.99 },
];
...
const CATEGORY_BADGE_COLORS = {
  ...
  'Nat Gas': 'bg-red-100 text-red-700',
